package io.github.jaqat.remoterobot.tests;
...
import io.github.jaqat.remoterobot.enums.Browser;
import io.github.jaqat.remoterobot.enums.RemoteBrowserProvider;
import io.github.jaqat.remoterobot.utils.GgrUtils;
import io.github.jaqat.remoterobot.utils.SelenoidUtils;
...
import static io.github.jaqat.remoterobot.config.TestsConfig.*;
import static io.github.jaqat.remoterobot.enums.RemoteBrowserProvider.*;
import static java.awt.event.KeyEvent.*;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class RemoteRobotTest {
    
    private static Stream<Arguments> crossBrowserTests() {
    ...
    void checkGetPixelColor(RemoteBrowserProvider remoteBrowserProvider, Browser browser) {
        initRemoteWebDriver(browser, remoteBrowserProvider);
        openTestPage();
        RemoteRobot remoteRobot = getRemoteRobot(remoteBrowserProvider);
    ...
    void checkCaptureScreen(RemoteBrowserProvider remoteBrowserProvider, Browser browser) throws IOException {
        ...
        BufferedImage expectedImage = getExpectedImage(browser);
    ...
    private BufferedImage getExpectedImage(Browser browser){
        try {
            switch (browser) {
                case CHROME:
                    return ImageIO.read(
            ...
            throw new IllegalStateException("Can't get image from resources", ioe);
        }
    }
    ...
    private RemoteRobot getRemoteRobot(RemoteBrowserProvider remoteBrowserProvider) {
    ...
    private void initRemoteWebDriver(Browser browser, RemoteBrowserProvider remoteBrowserProvider) {
